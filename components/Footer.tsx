...
export default function Footer() {
  return (
    ...
    //     <p>&copy; 2023 Eco-Track. All rights reserved.</p>
    //     <p>Combining economic value with social impact through environmental cleanup</p>
    //   </div>
    // </footer>
    <footer className="bg-green-600 text-white py-8 mt-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h4 className="text-lg font-semibold mb-4">About Eco-Track</h4>
              <p className="text-sm">Eco-Track is a platform dedicated to promoting environmental conservation through community engagement and rewards.</p>
            </div>
            <div>
          ...
          <div className="mt-8 text-center">
            <p>&copy; {new Date().getFullYear()} Eco-Track. All rights reserved.</p>
          </div>
        </div>
      </footer>
  );
